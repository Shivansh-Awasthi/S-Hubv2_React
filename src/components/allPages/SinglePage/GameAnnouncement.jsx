...
const GameAnnouncement = ({ announcements }) => {  // Receive announcements as prop
    ...
    return (
        <div className='mt-4 ring-2 ring-[#9709e3] rounded-lg hover:ring-opacity-75'>
            ...
            {announcements[1] && (
                <div className="text-sm text-gray-200 sm:text-base flex gap-4 justify-center items-center py-2 px-6 sm:px-10 inline-block w-full">
            ...
            {announcements[2] && (
                <div className="mt-1">
                    <p className="text-sm text-gray-200 sm:text-base flex flex-wrap justify-center items-center py-3 px-6 sm:px-10 w-full rounded-lg bg-[#2E2E2E] hover:bg-[#1E1E1E] transition break-all">
            ...
            {announcements[3] && (
                <div className="mt-1 text-gray-200 text-sm sm:text-base">
