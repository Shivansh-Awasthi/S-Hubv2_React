...
function AndroidSoftwares() {
    ...
    return (
        ...
        <div>
            ...
            <title>Download Android Softwares for Free | ToxicGame</title>
            <meta
                name="description"
                content="Explore and download all the best Android softwares for free from ToxicGame. Full Softwares, games, Pre-Installed, and more for Android."
            />
            <link rel="canonical" href="https://toxicgame.net/category/android/softwares" />
            {/* Open Graph / Link preview */}
            <meta property="og:title" content={`Download Android Softwares for Free | ToxicGame`} />
            <meta property="og:description" content={`Explore and download all the best Android softwares for free from ToxicGame. Full Softwares, games, and more for Android.`} />
